	...
	float3& p_view)
{
	...
	// If far_plane < 0, only check near_plane; otherwise, check both near and far
	bool inside_frustum = (far_plane < 0.0f) ? (p_view.z > near_plane) : (p_view.z > near_plane && p_view.z < far_plane);
